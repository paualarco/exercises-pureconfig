...
This repository hosts a content library for the [Scala Exercises](https://www.scala-exercises.org/) platform that includes interactive exercises related to [Pureconfig](https://github.com/pureconfig/pureconfig).
